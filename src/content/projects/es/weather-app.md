...
sections:
  ...
  - title: "Búsqueda Inteligente e Historial"
    body: "La barra de búsqueda recuerda tus ciudades recientes y las sugiere mientras escribes — sin necesidad de volver a escribir la misma ubicación. Los resultados aparecen al instante, haciendo que sea rápido alternar entre ciudades que revisas frecuentemente."
    image: "/projects/weather-app/forecast.png"
    imageAlt: "Autocompletado de búsqueda con ciudades recientes y sección del pronóstico de 5 días"
    imageCaption: "Pronóstico extendido de 5 días con temperaturas máx/mín y probabilidad de lluvia."
    layout: "image-left"

  - title: "Consejos Meteorológicos Personalizados"
    body: "Haz clic en 'Ver Consejos' y aparece un modal con recomendaciones adaptadas a tus condiciones actuales — qué ropa usar, si es seguro conducir, si debes llevar paraguas. Los consejos son completamente bilingües y reaccionan dinámicamente al clima detectado."
    image: "/projects/weather-app/mobile.png"
    imageAlt: "Vista móvil mostrando el diseño responsivo de la app"
    imageCaption: "Completamente responsiva — funciona igual de bien en teléfono que en escritorio."
    layout: "image-right"
